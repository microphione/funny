...
const GameRender = {
    ...
    getTileSprite(tile, wx, wy, animFrame) {
        ...
        switch (tile) {
            ...
            case T.WALL: case T.CAVE_WALL: return 'wall';
            case T.TREE: return 'tree';
            case T.HOUSE: case T.VILLAGE_HUT: return 'house';
            case T.DOOR: return 'door';
            case T.SHOP_WEAPON: case T.SHOP_ARMOR: case T.SHOP_POTION: return 'shop';
            case T.SHOP_FLOOR: return `path_${v}`;
            case T.SHOP_WEAPON_NPC: return 'npc_shop';
            case T.SHOP_ARMOR_NPC: return 'npc_shop';
            case T.SHOP_POTION_NPC: return 'npc_shop';
            case T.INN: return 'inn';
            case T.BRIDGE: return 'bridge';
            case T.CAVE_FLOOR: return 'cave_floor';
            ...
            case T.STONE_FLOOR: return `stone_floor_${v % 2}`;
            ...
            case T.NPC_QUEST: case T.NPC_QUEST2: return 'npc_quest';
            case T.NPC_SHOPKEEPER: return 'npc_shop';
